...
namespace SetMeta.Web.Services.Data
{
    public class SetMetaDbMigrationConfiguration : DbMigrationsConfiguration<SetMetaDbContext>
    {
        ...
        protected override void Seed(SetMetaDbContext context)
        {
            ...
            var univercityPublicId = AddMetaDataType(context, "Univercities");

            AddMetaData(context, "Univercities", univercityPublicId, "Abant İzzet Baysal Üniversitesi", "ibu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Abdullah Gül Üniversitesi", "agu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Adana Bilim ve Teknoloji Üniversitesi", "adanabtu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Adnan Menderes Üniversitesi", "adu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Adıyaman Üniversitesi", "adiyaman.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Afyon Kocatepe Üniversitesi", "aku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ahi Evran Üniversitesi", "ahievran.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Akdeniz Üniversitesi", "akdeniz.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Aksaray Üniversitesi", "aksaray.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Amasya Üniversitesi", "amasya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Anadolu Üniversitesi", "anadolu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ankara Sosyal Bilimler Üniversitesi", "asbu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ankara Üniversitesi", "ankara.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ardahan Üniversitesi", "ardahan.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Artvin Çoruh Üniversitesi", "artvin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Atatürk Üniversitesi", "atauni.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ağrı İbrahim Çeçen Üniversitesi**", "agri.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Balıkesir Üniversitesi", "balikesir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bartın Üniversitesi", "bartin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Batman Üniversitesi", "batman.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bayburt Üniversitesi", "bayburt.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bilecik Şeyh Edebali Üniversitesi**", "bilecik.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bingöl Üniversitesi", "bingol.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bitlis Eren Üniversitesi", "beu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bozok Üniversitesi", "bozok.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Boğaziçi Üniversitesi", "boun.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bursa Teknik Üniversitesi", "btu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bülent Ecevit Üniversitesi**", "beun.edu.tr/");
            AddMetaData(context, "Univercities", univercityPublicId, "Celal Bayar Üniversitesi", "bayar.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Cumhuriyet Üniversitesi", "cumhuriyet.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Deniz Harp Okulu", "dho.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Dicle Üniversitesi", "dicle.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Dokuz Eylül Üniversitesi", "deu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Dumlupınar Üniversitesi", "dpu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Düzce Üniversitesi", "duzce.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ege Üniversitesi", "ege.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Erciyes Üniversitesi", "erciyes.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Erzincan Üniversitesi", "erzincan.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Erzurum Teknik Üniversitesi", "erzurum.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Eskişehir Osmangazi Üniversitesi", "ogu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Fırat Üniversitesi", "firat.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Galatasaray Üniversitesi", "gsu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gazi Üniversitesi", "gazi.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gaziantep Üniversitesi", "gantep.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gaziosmanpaşa Üniversitesi", "gop.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gebze Yüksek Teknoloji Enstitüsü", "gyte.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Giresun Üniversitesi", "giresun.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gülhane Askeri Tıp Akademisi", "gata.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gümüşhane Üniversitesi", "gumushane.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Hacettepe Üniversitesi", "hacettepe.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Hakkari Üniversitesi", "hakkari.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Harran Üniversitesi", "harran.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Hitit Üniversitesi", "hitit.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İnönü Üniversitesi", "inonu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Medeniyet Üniversitesi", "medeniyet.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Teknik Üniversitesi", "itu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Üniversitesi", "istanbul.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İzmir Kâtip Çelebi Üniversitesi**", "ikc.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İzmir Yüksek Teknoloji Enstitüsü", "iyte.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Iğdır Üniversitesi", "igdir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kafkas Üniversitesi", "kafkas.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kahramanmaraş Sütçü İmam Üniversitesi", "ksu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kara Harp Okulu", "Kara Harp Okulu");
            AddMetaData(context, "Univercities", univercityPublicId, "Karabük Üniversitesi", "karabuk.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Karadeniz Teknik Üniversitesi", "ktu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Karamanoğlu Mehmetbey Üniversitesi", "kmu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kastamonu Üniversitesi", "kastamonu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kilis 7 Aralık Üniversitesi", "kilis.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kocaeli Üniversitesi", "kocaeli.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kırklareli Üniversitesi", "kirklareli.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kırıkkale Üniversitesi", "kku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mardin Artuklu Üniversitesi", "artuklu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Marmara Üniversitesi", "marmara.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mehmet Akif Ersoy Üniversitesi", "mehmetakif.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mersin Üniversitesi", "mersin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mimar Sinan Güzel Sanatlar Üniversitesi", "msgsu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mustafa Kemal Üniversitesi", "mku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Muğla Üniversitesi", "mugla.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Muş Alparslan Üniversitesi", "alparslan.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Namık Kemal Üniversitesi", "nku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Necmettin Erbakan Üniversitesi", "konya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Nevşehir Üniversitesi", "nevsehir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Niğde Üniversitesi", "nigde.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ondokuz Mayıs Üniversitesi", "omu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ordu Üniversitesi", "odu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Orta Doğu Teknik Üniversitesi", "odtu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Osmaniye Korkut Ata Üniversitesi", "osmaniye.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Pamukkale Üniversitesi", "pamukkale.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Polis Akademisi", "pa.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Recep Tayyip Erdoğan Üniversitesi**", "rize.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Sakarya Üniversitesi", "sakarya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Selçuk Üniversitesi", "selcuk.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Siirt Üniversitesi", "siirt.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Sinop Üniversitesi", "sinop.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Süleyman Demirel Üniversitesi", "sdu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Trakya Üniversitesi", "trakya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Tunceli Üniversitesi", "tunceli.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Türk Alman Üniversitesi", "tau.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Uludağ Üniversitesi", "uludag.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Uşak Üniversitesi", "usak.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yalova Üniversitesi", "yalova.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yüzüncü Yıl Üniversitesi", "yyu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yıldırım Beyazıt Üniversitesi", "ybu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yıldız Teknik Üniversitesi", "yildiz.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Çanakkale Onsekiz Mart Üniversitesi", "comu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Çankırı Karatekin Üniversitesi", "karatekin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Çukurova Üniversitesi", "cu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Şırnak Üniversitesi", "sirnak.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Acıbadem Üniversitesi", "acibadem.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Alanya Hamdullah Emin Paşa Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "Ankara Bilge Üniversitesi", "bilge.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Atılım Üniversitesi", "atilim.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Avrasya Üniversitesi", "avrasya.edu.tr/");
            AddMetaData(context, "Univercities", univercityPublicId, "Bahçeşehir Üniversitesi", "bahcesehir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Başkent Üniversitesi", "baskent.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Beykent Üniversitesi", "beykent.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bezmiâlem Vakıf Üniversitesi", "bezmialem.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bilkent Üniversitesi", "bilkent.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Bursa Orhangazi Üniversitesi", "bou.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Canik Başarı Üniversitesi", "basari.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Çankaya Üniversitesi", "cankaya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Çağ Üniversitesi", "cag.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Doğuş Üniversitesi", "dogus.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Fatih Sultan Mehmet Üniversitesi", "fatihsultan.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Fatih Üniversitesi", "fatihun.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gedik Üniversitesi", "gedik.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Gediz Üniversitesi", "gediz.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Haliç Üniversitesi", "halic.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Hasan Kalyoncu Üniversitesi**", "hku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Işık Üniversitesi", "isikun.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İpek Üniversitesi**", "altinkoza.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul 29 Mayıs Üniversitesi", "29mayis.edu.tr/");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Arel Üniversitesi", "arel.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Aydın Üniversitesi", "aydin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Bilgi Üniversitesi", "bilgi.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Bilim Üniversitesi", "istanbulbilim.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Esenyurt Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Gelişim Üniversitesi", "gelisim.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Kemerburgaz Üniversitesi", "kemerburgaz.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Kültür Üniversitesi", "iku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Medipol Üniversitesi", "medipol.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Mef Üniversitesi", "mef.k12.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Sabahattin Zaim Üniversitesi", "iszu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Şehir Üniversitesi", "sehir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İstanbul Ticaret Üniversitesi", "iticu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İzmir Ekonomi Üniversitesi", "ieu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "İzmir Üniversitesi", "izmir.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kadir Has Üniversitesi", "khas.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Karatay Üniversitesi", "karatay.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Koç Üniversitesi", "ku.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Konya Gıda Tarım Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "Maltepe Üniversitesi", "maltepe.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Melikşah Üniversitesi", "meliksah.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Mevlana Üniversitesi", "mevlana.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Murat Hüdavendigar Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "Nişantaşı Üniversitesi", "nisantasi.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Nuh Naci Yazgan Üniversitesi", "nny.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Okan Üniversitesi", "okan.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Özyeğin Üniversitesi", "ozyegin.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Piri Reis Üniversitesi", "pirireis.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Sabancı Üniversitesi", "sabanciuniv.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Sanko Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "Selahattin Eyyubi Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "Süleyman Şah Üniversitesi", "ssu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Şifa Üniversitesi", "sifa.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "TED Üniversitesi", "tedu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "TOBB Ekonomi ve Teknoloji Üniversitesi", "etu.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Toros Üniversitesi", "toros.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Turgut Özal Üniversitesi", "turgutozal.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Türk Hava Kurumu Üniversitesi", "thk.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Ufuk Üniversitesi", "ufuk.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Uluslararası Antalya Üniversitesi", "antalya.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Üsküdar Üniversitesi", "uskudar.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yaşar Üniversitesi", "yasar.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yeditepe Üniversitesi", "yeditepe.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Yeni Yüzyıl Üniversitesi", "yeniyuzyil.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Zirve Üniversitesi", "zirve.edu.tr");
            AddMetaData(context, "Univercities", univercityPublicId, "Kanuni Üniversitesi", "");
            AddMetaData(context, "Univercities", univercityPublicId, "MEF Üniversitesi", "mef.edu.tr");
            #endregion
